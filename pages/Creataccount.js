     ...
     <View style={styles.forgets}>
      <View style={styles.textContainer}>
        <Text style={styles.Logged}>
          <aside style={styles.checkboxContainer}>
            <input type="checkbox" placeholder="checkbox" style={styles.checkbox} />
          </aside>
          I agree with the T terms and conditions by creating an account
        </Text>
      </View>
    </View>
